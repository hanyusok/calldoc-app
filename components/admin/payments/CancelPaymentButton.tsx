...
export default function CancelPaymentButton({
    ...
    return (
        <button
            ...
            disabled={loading}
            className="text-red-600 hover:text-red-900 disabled:opacity-50 text-xs border border-red-200 px-2 py-1 rounded bg-red-50 hover:bg-red-100 whitespace-nowrap"
        >
            {loading ? "..." : label}
        </button>
    );
