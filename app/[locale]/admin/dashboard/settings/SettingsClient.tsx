            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 space-y-6">
                <div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">
                                {t('prescription_pdf_path')}
                            </label>
                            <input
                                type="text"
                                value={settings.prescriptionPdfPath}
                                onChange={(e) => setSettings({ ...settings, prescriptionPdfPath: e.target.value })}
                                className="w-full p-2 border rounded-lg outline-none focus:ring-2 focus:ring-blue-500 font-mono text-sm"
                                placeholder="C:\Mts3\PDF"
                                dir="ltr"
                            />
                            <p className="text-xs text-gray-500 mt-1">{t('prescription_pdf_path_desc')}</p>
                        </div>
                    </div>
                </div>
